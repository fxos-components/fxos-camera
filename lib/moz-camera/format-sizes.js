 ...
 * @return {Array}
 */
exports.picture = function(items, options) {
  debug('picture', items);
  ...
  // Sort by pixel size
  result.sort(function(a, b) { return b.pixelSize - a.pixelSize; });
 ...
 * @return {Array}
 */
exports.video = function(profiles, options) {
...
})})(((n,w)=>{return(typeof define)[0]=='f'&&define.amd?define:(typeof module)[0]=='o'?c =>{c(require,exports,module)}:c=>{var m={exports:{}},r=n=>w[n];w[n]=c(r,m.exports,m)||m.exports;};})('./format-sizes',this));/*jshint ignore:line*/